...
# New models for admin functionality
class Review(BaseModel):
    ...
    def __str__(self):
        return f"{self.title} - {self.rating} stars by {self.user.full_name}"
...
class Enquiry(BaseModel):
    ...
    pest_types = models.JSONField(default=list)  # Store as array
